...
const AdminNav = () => {
  ...
  return (
    <div className={`fixed left-0 top-0 h-screen bg-gray-300 overflow-y-auto transition-all ${collapsed ? 'w-16' : 'w-40'}`}>
      <div className="flex items-center justify-center w-16 h-16 mt-auto bg-indigo-800 hover:bg-indigo-700" onClick={toggleCollapse}>
...
{/* <div className="fixed left-0 top-0 h-screen space-x-6 bg-gray-300 overflow-y-auto">
...
// 				  </a>
// 				  <a class="flex items-center w-full h-12 px-3 mt-2  bg-indigo-700 text-indigo-100 rounded" href="#">
// 					  <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
// 						  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
// 					  </svg>
